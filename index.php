            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
              <div class="card mb-4 text-center bg-ash border-none relative">
                ...
                <div class="card-body">
                  ...
                  <h6 class="product-price d-none"> <span class="d-none">$29.99</span> <del class="d-none">$49.99</del></h6>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="col-lg-6 col-12">
        <div class="lab-item">
          <div class="lab-content">
            <h3>Chicken Life-cycle</h3>
            <p>Continually productize compelling quality for packed with Elated Themes Setting up to website and it crating pages.
            </p>
            <div class="row mt-5">
              <div class="col-12">
...
<section class="team-section padding-tb d-none">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <div class="section-header">
...
<section class="blog-section relative padding-tb d-none">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <div class="section-header">
